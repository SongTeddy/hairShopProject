...
<div class="myPage" style="height: auto;">
   <div class="myPage_menu">
      <ul class="myPage_menu_ul">
        ...
        <li class="myPage_menu_li"><a href="/hairShopProject/adminPage/bannerManagement.do">배너 관리</a></li>
        <li class="myPage_menu_li"><a href="/hairShopProject/adminPage/recommendManagement.do">추천 헤어샵 관리</a></li>
      </ul>
   </div>
