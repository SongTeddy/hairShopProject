...
<font size="6pt" style="color: #363636;">이벤트  리스트</font><br>
	...
	<div class="btnDiv">
		<input type="button" class="btn btn-default" id="insertNewEvent" value="이벤트 추가" onclick="location.href='/hairShopProject/adminPage/eventManagement.do'">
	</div>

	<br/>
	<font size="4pt">진행중인 이벤트</font>
